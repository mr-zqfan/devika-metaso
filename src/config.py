...
class Config:
    ...
    def get_metaso_api_key(self):
        return self.config["API_KEYS"]["METASO"]

    def get_metaso_api_base_url(self):
        return self.config["API_ENDPOINTS"]["METASO"]
    ...
    def get_proxy_http_proxy(self):
        return self.config["PROXY"]["HTTP_PROXY"]

    def get_proxy_https_proxy(self):
        return self.config["PROXY"]["HTTPS_PROXY"]

    def get_proxy_no_proxy(self):
        return self.config["PROXY"]["NO_PROXY"]

    def get_web_search_no_sites(self):
        return self.config["WEB_SEARCH"]["NO_SITES"].split(",")

    def get_features_enable_keyword_extraction(self):
        return self.config["FEATURES"]["ENABLE_KEYWORD_EXTRACTION"] == "true"
